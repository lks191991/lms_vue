        ...
        <nav class="navbar navbar-expand-xl navbar-light bg-transparent">
            <div class="container">
                ...
                <a class="navbar-brand" href="/">
                    <img src="{{asset('front/dist/images/logo/logo.png')}}" alt="Logo" class="img-fluid" />
                </a>
                ...
                <div class="collapse navbar-collapse d-none d-xl-block" id="navbarSupportedContent">
                    ...
                    <div class="d-flex align-items-center rightContent rightContent-2">
                        ...
                        <a href="cart.html" class="cart-nav border-0 bg-transparent ms-4 me-1">
                        ...
                        <div class="user-image ms-3">
                            <a href="students-profile.html">
                                <img src="dist/images/ellipse/user.jpg" alt="User" />
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="navbar-mobile">
                    <div>
                        <div class="navbar-mobile__top">
                            <a href="index.html"> <img src="dist/images/logo/logo.png" alt="brand" class="img-fluid" />
                            </a>
                            <div>
                                <a href="cart.html" class="cart-nav">
                                    ...
                                    <span class="badge bg-primary">2</span> <span class="visually-hidden">Items
                                        Added</span>
                                </a>
                        ...
                        <div class="navbar-mobile__menu">
                            <ul class="navbar-mobile__menu-list">
                                ...
                                <li class="active navbar-mobile__menu-item">
                                    ...
                                    <ul class="navbar-mobile__menu-dropmenu">
                                        <li><a href="students-profile.html" class="active">Students Profile</a></li>
