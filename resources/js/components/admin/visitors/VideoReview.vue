          ...
          <div class="col-12">
            ...
            <div class="card" v-if="$gate.isAdmin()">
              <div class="card-header">
                <h3 class="card-title">Video Reviews</h3>
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                     <tr v-for="data in listData.data" :key="data.id">
                      ...
                      <td>{{data.video.course.name}}</td>
					   <td>{{data.video.name}}</td>
                      <td>{{data.rating}}</td>
                      <td>{{data.comment}}</td>
        ...
        methods: {
            ...
            getResults(page = 1) {
				this.loading = true
                  ...
                  axios.get('/api/video-review?page=' + page).then(({ data }) => {this.listData = data.data;
				  this.loading = false
				  });
			 ...
			 loadData(){
                ...
                if(this.$gate.isAdmin()){
                    axios.get("/api/video-review").then(({ data }) => {this.listData = data.data;
					this.loading = false
					});
                }
            },
