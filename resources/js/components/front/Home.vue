            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="home-banner-img text-md-end position-relative">
                        <img src="/front/dist/images/newDesign/banner-img.png" alt="banner-img" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="new__courses">
                <div class="contentCard contentCard--marketing shadow-sm mb-1">
                    <div class="contentCard-top">
                        <a href="course-details.html">
                            <img src="/front/dist/images/newDesign/onlineCourse1.png" alt="images" class="img-fluid" />
                        </a>
                    </div>
                    <div class="contentCard-bottom">
                        ...
                        <div class="contentCard-info d-flex align-items-center justify-content-between">
                            <a href="instructor-profile.html" class="contentCard-user d-flex align-items-center">
                                <img src="/front/dist/images/newDesign/courseInstructorIcon.png" alt="client-image"
                        ...
                        <div class="contentCard-more">
                            <div class="d-flex align-items-center">
                                <div class="icon">
                                    <img src="/front/dist/images/icon/eye.png/" alt="eye" />
                                </div>
                                <span>24,517</span>
                            </div>
                            <div class="d-flex align-items-center">
                                <div class="icon">
                                    <img src="/front/dist/images/icon/book.png" alt="book" />
                                </div>
                                <span>37 Lesson</span>
                            </div>
                            <div class="d-flex align-items-center">
                                <div class="icon">
                                    <img src="/front/dist/images/icon/clock.png" alt="clock" />
                                </div>
                                <span>3 Hours</span>
                            </div>
                        </div>
                ...
                <div class="contentCard contentCard--marketing shadow-sm mb-1">
                    <div class="contentCard-top">
                        <a href="course-details.html">
                            <img src="/front/dist/images/newDesign/onlineCourse2.png" alt="images" class="img-fluid" />
                        </a>
                    </div>
                    <div class="contentCard-bottom">
                        <span class="contentCard--type">marketing</span>
                ...
                <div class="contentCard contentCard--marketing shadow-sm mb-1">
                    <div class="contentCard-top">
                        <a href="course-details.html">
                            <img src="/front/dist/images/newDesign/onlineCourse3.png" alt="images" class="img-fluid" />
                        </a>
                    </div>
                    <div class="contentCard-bottom">
                        <span class="contentCard--type">marketing</span>
            ...
            <div class="row">
                    ...
                    <div class="find-courses-category-block section--bg-white">
                        <a href="#" class="text-reset d-flex flex-wrap">
                            <div class="find-courses-category-img">
                                <img src="/front/dist/images/newDesign/category1.png" alt="category" />
                            </div>
                ...
                <div class="col-md-4">
                    <div class="find-courses-category-block section--bg-white">
                        <a href="#" class="text-reset d-flex flex-wrap">
                            <div class="find-courses-category-img">
                                <img src="/front/dist/images/newDesign/category2.png" alt="category" />
                            </div>
                            <div class="find-courses-category-cont">
                ...
                <div class="col-md-4">
                    <div class="find-courses-category-block section--bg-white">
                        <a href="#" class="text-reset d-flex flex-wrap">
                            <div class="find-courses-category-img">
                                <img src="/front/dist/images/newDesign/category3.png" alt="category" />
                            </div>
                            <div class="find-courses-category-cont">
                ...
                <div class="col-md-4">
                    <div class="find-courses-category-block section--bg-white">
                        <a href="#" class="text-reset d-flex flex-wrap">
                            <div class="find-courses-category-img">
                                <img src="/front/dist/images/newDesign/category4.png" alt="category" />
                            </div>
                            <div class="find-courses-category-cont">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="why-choose-block bgShade1 shadow">
                        <div class="why-choose-img bg-white">
                            <img src="/front/dist/images/newDesign/whyChoose1.png" alt="whyChoose" />
                        </div>
                ...
                <div class="col-md-4">
                    <div class="why-choose-block bgShade2 shadow">
                        <div class="why-choose-img bg-white">
                            <img src="/front/dist/images/newDesign/whyChoose2.png" alt="whyChoose" />
                        </div>
                        <div class="why-choose-cont">
                ...
                <div class="col-md-4">
                    <div class="why-choose-block bgShade3 shadow">
                        <div class="why-choose-img bg-white">
                            <img src="/front/dist/images/newDesign/whyChoose3.png" alt="whyChoose" />
                        </div>
                        <div class="why-choose-cont">
                ...
                <div class="testimonial__item">
                    ...
                    <div class="testimonial__user d-flex align-items-center justify-content-lg-start">
                        <div class="testimonial__user-img">
                            <img src="/front/dist/images/newDesign/avatar-img-testimonial.png" alt="Client" />
                        </div>
